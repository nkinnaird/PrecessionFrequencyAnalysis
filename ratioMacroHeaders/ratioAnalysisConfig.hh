// config file for what fit conditions are being used in the analysis when using ratioMacro.C

#ifndef RATIOANALYSISCONFIG_HH
#define RATIOANALYSISCONFIG_HH
...
/////////////////////////////////////////////////////////////////////////////////////
    ...
    // static const vector<int> fitIndividualCalos{9, 22};

/////////////////////////////////////////////////////////////////////////////////////

    static const int trackerStationModel = 12; // 18
...
/////////////////////////////////////////////////////////////////////////////////////
    ...
    static const bool ratioFit_Include2CBO = true;
    static const bool ratioFit_IncludeACBO = true;
    static const bool ratioFit_IncludePhiCBO = true;
...
/////////////////////////////////////////////////////////////////////////////////////
    ...
    // static const vector<string> TmethodFit_added_fixedParameters {tau_string};
    // static const vector<string> TmethodFit_added_fixedParameters {cbo_tau_string, cbo_w_string};
    ...
    // static const vector<string> TmethodFit_scan_fixedParameters {tau_string}; // extra vector so that the first fit is allowed to float - only applies to fit start scan at the moment
    ...
    static const bool TmethodFit_Include2CBO = true;
    static const bool TmethodFit_IncludeACBO = true;
    static const bool TmethodFit_IncludePhiCBO = true;
...
/////////////////////////////////////////////////////////////////////////////////////
    ...
    // static const double parameterScanStart = 2.634 - 10 * 0.041;
    // static const double parameterScanStep = 0.041;
    // static const string parameterToScan = cbo_tau_string;
    // static const double parameterScanStart = 116.4 - 5 * 10.3;
    // static const double parameterScanStep = 10.3;

/////////////////////////////////////////////////////////////////////////////////////

    static const double defaultFitStart = 30287.6; // 49982.0; // 29094; // 30200; // 32525.6; half a g-2 period later
...
/////////////////////////////////////////////////////////////////////////////////////
    ...
    static const int totalAnalysesPasses = 1;

    static const double startTimeOfFit = defaultFitStart;
    static const double fitStartStep = 0;

    static const double endTimeOfFit = defaultFitEnd;
    static const double fitEndStep = 0;
    static const bool adaptiveFitEndTime = false; // boolean to set the fit time for each individual iteration based on the number of statistics in the fitted histograms - will overwrite the fit end time accordingly regardless of what the settings are
...
void setDataset(int datasetCase, int trackerCase){
  ...
  switch(datasetCase){
    ...
    // lostMuonsFilePath = "/gm2/data/users/nkinnaird/Ratio/FinalProductions/60h/SingleIter/LostMuonFits/TimeCuts/LostMuons-60h-TimeCuts.root"; // time cuts
    // lostMuonsFilePath = "/gm2/data/users/nkinnaird/Ratio/FinalProductions/60h/SingleIter/LostMuonFits/EnergyCuts/LostMuons-60h-EnergyCuts.root"; // energy cuts
    // lostMuonsFilePath = "/gm2/data/users/nkinnaird/Ratio/FinalProductions/60h/SingleIter/LostMuonFits/NegativeSide/LostMuons-60h-NegativeSide.root"; // negative side cut
...
/////////////////////////////////////////////////////////////////////////////////////
    ...
    // lostMuonsFilePath = "/gm2/data/users/nkinnaird/Ratio/FinalProductions/9d/SingleIter/LostMuonFits/TimeCuts/LostMuons-9d-TimeCuts.root"; // time cuts
    // lostMuonsFilePath = "/gm2/data/users/nkinnaird/Ratio/FinalProductions/9d/SingleIter/LostMuonFits/EnergyCuts/LostMuons-9d-EnergyCuts.root"; // energy cuts
    // lostMuonsFilePath = "/gm2/data/users/nkinnaird/Ratio/FinalProductions/9d/SingleIter/LostMuonFits/NegativeSide/LostMuons-9d-NegativeSide.root"; // negative side cut
    if(useSeparateLostMuonsFile) cout << "Using separate lost muons file: " << lostMuonsFilePath << endl;
...
/////////////////////////////////////////////////////////////////////////////////////
    ...
    // lostMuonsFilePath = "/gm2/data/users/nkinnaird/Ratio/FinalProductions/Endgame/SingleIter/LostMuonFits/TimeCuts/LostMuons-EG-TimeCuts.root"; // time cuts
    // lostMuonsFilePath = "/gm2/data/users/nkinnaird/Ratio/FinalProductions/Endgame/SingleIter/LostMuonFits/EnergyCuts/LostMuons-EG-EnergyCuts.root"; // energy cuts
    // lostMuonsFilePath = "/gm2/data/users/nkinnaird/Ratio/FinalProductions/Endgame/SingleIter/LostMuonFits/NegativeSide/LostMuons-EG-NegativeSide.root"; // negative side cut
    if(useSeparateLostMuonsFile) cout << "Using separate lost muons file: " << lostMuonsFilePath << endl;
    ...
    startingLMAmp = 2.634; // 1.709 - base cuts
...
/////////////////////////////////////////////////////////////////////////////////////
    ...
    // lostMuonsFilePath = "/gm2/data/users/nkinnaird/Ratio/FinalProductions/HighKick/SingleIter/LostMuonFits/TimeCuts/LostMuons-HK-TimeCuts.root"; // time cuts
    // lostMuonsFilePath = "/gm2/data/users/nkinnaird/Ratio/FinalProductions/HighKick/SingleIter/LostMuonFits/EnergyCuts/LostMuons-HK-EnergyCuts.root"; // energy cuts
    // lostMuonsFilePath = "/gm2/data/users/nkinnaird/Ratio/FinalProductions/HighKick/SingleIter/LostMuonFits/NegativeSide/LostMuons-HK-NegativeSide.root"; // negative side cut
    if(useSeparateLostMuonsFile) cout << "Using separate lost muons file: " << lostMuonsFilePath << endl;
