// 3-31-20: Macro for plots for scans over IFG parameters, amplitude or lifetime.
...
pair<double, double> lineFunc_shortRange {0.8, 1.5};
TF1* lineFunc = new TF1("lineFunc", "[0] + (x * [1])", lineFunc_fullRange.first, lineFunc_fullRange.second);

pair<double, double> parabFunc_fullRange {-1, 3};
pair<double, double> parabFunc_shortRange {1, 2};
TF1* parabFunc = new TF1("parabFunc", "[2] * (x - [1]) * (x - [1]) + [0]", parabFunc_fullRange.first, parabFunc_fullRange.second);
...
int inFillGainCrystalsScan(std::string filePath)
{
  // gROOT->SetBatch(kTRUE); // set batch mode to true for this macro so that nothing draws to the screen

  if((saveImagesDirectly_amplitude? 1:0) + (saveImagesDirectly_lifetime? 1:0) > 1)
  {
  ...
  string outputFileName = "inFillGainCrystalsScan";
...
/////////////////////////////////////////////////////////////////////////////////////
    ...
    for (int fitPass = 0; fitPass < tP; ++fitPass)
    {
      ...
      amplitudes.push_back(float((*histSavedParameters)[11]));
      lifetimes.push_back(float((*histSavedParameters)[12]));
...
/////////////////////////////////////////////////////////////////////////////////////
    ...
    auto added_TMethod_amp_dir = added_TMethod_dir->mkdir("IFG_Amplitude");
    std::tuple<string, string, string> amp_info_TMethod("TMethod", "IFG Amplitude Multiplier", "T Method Fit");
    ...
    auto added_TMethod_tau_dir = added_TMethod_dir->mkdir("IFG_Lifetime");
    std::tuple<string, string, string> tau_info_TMethod("TMethod", "IFG Lifetime Multiplier", "T Method Fit");
...
/////////////////////////////////////////////////////////////////////////////////////
    ...
    auto added_FullRatio_amp_dir = added_FullRatio_dir->mkdir("IFG_Amplitude");
    std::tuple<string, string, string> amp_info_ratio("FullRatio", "IFG Amplitude Multiplier", "Full Ratio Fit");
    ...
    auto added_FullRatio_tau_dir = added_FullRatio_dir->mkdir("IFG_Lifetime");
    std::tuple<string, string, string> tau_info_ratio("FullRatio", "IFG Lifetime Multiplier", "Full Ratio Fit");
...
/////////////////////////////////////////////////////////////////////////////////////
    ...
    auto compare_amp_dir = compareDir->mkdir("IFG_Amplitude");
    compare_amp_dir->cd();
    ...
    if(saveImagesDirectly_amplitude){
      ...
      auto legend_chi2_amp = new TLegend(0.25,0.6,.55,0.8);
        ...
        ampMultiGraph_chisq->GetXaxis()->SetTitle("IFG Amplitude Multiplier");
        ...
        chi2Canvas_compare_amp->SaveAs(("Images/IFG_Amplitude_Compare_Chisq" + datasetTagForPlots + ".png").c_str());
...
/////////////////////////////////////////////////////////////////////////////////////
      ...
      auto legend_R_amp = new TLegend(0.25,0.6,.65,0.84);
        ...
        Rcanvas_compare_amp->SaveAs(("Images/IFG_Amplitude_Compare_R" + datasetTagForPlots + ".png").c_str());
    }
...
/////////////////////////////////////////////////////////////////////////////////////
    ...
    auto compare_tau_dir = compareDir->mkdir("IFG_Lifetime");
    compare_tau_dir->cd();
    ...
    if(saveImagesDirectly_lifetime){
      ...
      auto legend_chi2_tau = new TLegend(0.25,0.6,.55,0.8);
        ...
        tauMultiGraph_chisq->GetXaxis()->SetTitle("IFG Lifetime Multiplier");
        ...
        chi2Canvas_compare_tau->SaveAs(("Images/IFG_Lifetime_Compare_Chisq" + datasetTagForPlots + ".png").c_str());
...
/////////////////////////////////////////////////////////////////////////////////////
      ...
      auto legend_R_tau = new TLegend(0.23,0.6,.64,0.84);
        ...
        tauMultiGraph_R->GetXaxis()->SetTitle("IFG Lifetime Multiplier");
        ...
        RCanvas_compare_tau->SaveAs(("Images/IFG_Lifetime_Compare_R" + datasetTagForPlots + ".png").c_str());
    }
