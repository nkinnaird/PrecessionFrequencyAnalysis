/////////////////////////////////////////////////////////////////////////////////////
// Macro to perform T Method and Ratio Method fits on real data, in parallel.
// To run with an input file use: root ratioMacroParallel.C+\(\"filepath\"\,\"Iter{}\")
...
// This macro is distinct from ratioMacro.C because it is supposed to be ran in parallel on the virtual machines, where not only an input file is passed in, but an input iteration to be fit as well.
// Running over all fits depending on the analysis config can take a while, and it is important to make no changes to this file or included header files before all parallel sessions are done running, otherwise compilation errors arise.
// Example usage: for i in `seq 0 99`; do echo $i; done | xargs -i --max-procs=30 bash -c 'mkdir Iter{} && cd Iter{}; root -l -b -q $RP/ratioMacroParallel.C+\(\"../../../addedHists-60h-RandSeeds.root\",\"Iter{}\"\)'
// This macro points to the ratioAnalysisConfigParallel.hh config file. This extra header file was made such that the normal ratioMacro.C file could be ran simultaneously with changes to ratioAnalysisConfig.hh without affecting the running of this macro. 
/////////////////////////////////////////////////////////////////////////////////////
...
#include "ratioAnalysisConfigParallel.hh"
...
int ratioMacroParallel(string filePath, string iterIn)
{
...
/////////////////////////////////////////////////////////////////////////////////////
  ...
  // CopyFile(filePath.c_str()); // copy the input file into the output file - commenting out because it adds 100 MB to the file, which after many output files are produced adds up
    ...
    /////////////////////////////////////////////////////////////////////////////////////
      ...
      added_Tmethod_Dir->cd();
        ...
        allTimesAdded_TMethod->ResetStats();
            ...
            // if(iterNum == 5 || iterNum == 64) TmethodFitClass.fillDiffParLimits(cbo_N2_phi_string, 3, 7);
            // if(iterNum == 9) TmethodFitClass.fillDiffParLimits(cbo_N2_phi_string, 4, 6);
            // if(iterNum == 14) TmethodFitClass.fillDiffParLimits(cbo_N2_phi_string, 6, 8);
            // if(iterNum == 26) TmethodFitClass.fillDiffParLimits(cbo_N2_phi_string, 5, 8);
            // if(iterNum == 28) TmethodFitClass.fillDiffParLimits(cbo_N2_phi_string, 5, 8);
            // if(iterNum == 19 || iterNum == 20) TmethodFitClass.fillDiffParLimits(cbo_N2_phi_string, 2, 5);
...
*/
    /////////////////////////////////////////////////////////////////////////////////////
      ...
      fullRatio_Dir->cd();
            ...
            // fullRatioFitClass.fillDiffParLimits(cbo_N2_phi_string, 0, 2.5*pi); // use this for 9d scans (pileup multiplier had trouble with it so I expect other scans will too)
            
            // if(iterNum == 7) fullRatioFitClass.fillDiffParLimits(cbo_Phi_phi_string, 5, 7);
            // if(iterNum == 9) fullRatioFitClass.fillDiffParLimits(cbo_Phi_phi_string, 3, 7);
            // if(iterNum == 13) fullRatioFitClass.fillDiffParLimits(cbo_A_phi_string, 3, 7);
            // if(iterNum == 5 || iterNum == 17 || iterNum == 45 || iterNum == 64) fullRatioFitClass.fillDiffParLimits(cbo_N2_phi_string, 3, 7);
            // if(iterNum == 38) fullRatioFitClass.fillDiffParLimits(cbo_N2_phi_string, 5, 7.5);
            // if(iterNum == 9) fullRatioFitClass.fillDiffParLimits(cbo_N2_phi_string, 6, 8);
            // if(iterNum == 31) fullRatioFitClass.fillDiffParLimits(cbo_tau_string, 0, 500);
            // if(iterNum == 28) fullRatioFitClass.fillDiffParLimits(cbo_N2_phi_string, 3, 6);
...
/////////////////////////////////////////////////////////////////////////////////////
  ...
  if(fitIndividualCalos.size() > 0)
  {
    ...
    // perform individual T method fits 
        ...
        // if(caloNum == 2 || caloNum == 17) TmethodFitClass.fillDiffParLimits(cbo_w_string, 2.608, 2.612);
        // if(caloNum == 16) TmethodFitClass.fillDiffParLimits(tau_string, 64.39, 64.48);
...
*/
    ...
    // perform individual ratio fits
        ...
        fullRatioDir->cd();
            ...
            // if(caloNum == 11 || caloNum == 16) fullRatioFitClass.fillDiffParLimits(cbo_w_string, 2.332, 2.338);
